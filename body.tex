...
There exist few similar grid cmputing systems: LSF \cite{platformlsf}, OracleGrid \cite{oracleGridEngine} and HTCondor \cite{htcondor}.
\nb\ is an in-house solution that was implemented at Intel, and is tailord 
