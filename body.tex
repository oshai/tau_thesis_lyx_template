...
The data was collected from four of Intel's largest pools at different locations across the Intel farm. 
These pools were labeled A, B, C and D.
The recorded data contains one month period of jobs, and is stored in the 
Parallel Workload Archive \cite{parallel13}.
Table \ref{tab:jobs_properties} describes the properties of the recorded data.
...
show the distribution of the jobs' cores and memory requirements in four large pools %
