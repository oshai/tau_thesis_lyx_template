...
is altering resources requirments that were introduced during job submission. 
...
Tang et al.\ adjusted job's runtime estimates \cite{5470474} . This approach on the other hand, is not relevant to \nb\ .
\nb\ scheduler uses transient reservations, hence there is not promise about the actual dispatch 
